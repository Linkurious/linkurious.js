;(function(global) {
  ...
  sigma.prototype.startTransferablesWorkerForce = function(options) {
    var self = this,
        count = 0,
        nodes,
        edges;
    ...
    // Node attributes: x, y, size
    nodes = new Float32Array(this.graph.nodes().length * 3);
  ...
  sigma.prototype.stopTransferablesWorkerForce = function() {
    if (this.workerForce)
